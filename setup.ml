...
(* OASIS_START *)
(* DO NOT EDIT (digest: 70e314131fd696e206f9f15fa80aa96c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Josef Erben <josef@erben.io>"];
          homepage = Some "https://www.erben.io";
          bugreports = None;
          synopsis = "A cli tool that helps to remember things.";
          description =
            Some
              [
                 OASISText.Para
                   "Memb lets you store statements and search them."
              ];
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\151\225\145u\202]m\147\012\156;\136\203\188\\7";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
